  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="text-[#0055A3] text-[30px] font-semibold font-outfit mt-[68px]">
        ...
        <div className="flex items-start flex-wrap gap-[9px] mt-[14px]">
          ...
          <div>
            ...
            />
            <p className="text-[#DA170B] text-[15px] font-semibold leading-[18.075px] font-outfit mt-[15px]">
      ...
      <div className="max-w-[1055px] w-full mx-auto h-[5px] bg-[#008EDE] rounded-[5px] mt-[59px]"></div>

      <div className="flex items-start gap-[24px] mt-[64px] flex-wrap">
        <div className="max-w-[649px]">
          ...
          <p className="text-[21px] text-[#001B33] font-outfit leading-[34px] mt-[30px]">
            You can edit and upload your own 3 column pdf mailing matrix after
            you have downloaded the master mailing matrix from the Court. To
            learn how to modify and cross out address on the Master Mailing
            Matrix that you do not want to mail to, please click on the mailing
        ...
        <div className="min-w-[338px] max-w-[338px]">
          <p className="text-[#001B33] text-[15px] leading-[24.525px]">
            FORMATTING GUIDELINES:PLEASE REVIEW AND UNDERSTAND IF YOU ARE GOING
            TO UPLOAD YOUR OWN MAILING ADDRESS LISTS. YOU UPLOAD YOUR OWN LIST
            AT YOUR OWN RISK!
          </p>
          <Link to="/">
      ...
      <div className="mt-[60px]">
        <div className="flex items-center flex-wrap gap-[25px]">
          <h1 className="text-[#0055A3] font-semibold text-[20px] md:text-[40px] leading-[48px] font-outfit">
        ...
        <p className="text-[21px] text-[#001B33] font-outfit leading-[34px] mt-[30px]">
          We will accept a csv file (such as one you would create in Excel), but
          we ask that you follow our formatting procedures. Click on the button
          below to view our csv sample file. We have preformatted the column
          headers. You can simply cut and paste your addresses into the file,
          save it on your hard drive, and then attach it to this upload form
          using the file selection field above.
        </p>
      </div>
      <div className="mt-[60px]">
        <div className="flex items-center flex-wrap gap-[25px]">
        ...
        <p className="text-[21px] text-[#001B33] font-outfit leading-[34px] mt-[30px]">
          You can also create a one column text file of addresses. On a windows
          machine, you would use the Notepad program. There are some formatting
          rules to follow. Each address cannot be more than six lines and each
          address must be separated by one empty line. There is no limit to how
          many addresses you can place in your one column text file.
        </p>
      </div>
    </div>
  );
